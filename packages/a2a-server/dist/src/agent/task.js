 ...
 */
import { CoreToolScheduler, KaiDexEventType, ToolConfirmationOutcome, ApprovalMode, getAllMCPServerStatuses, MCPServerStatus, isNodeError, parseAndFormatApiError, } from "@google/kaidex-cli-core";
import { partListUnionToKaidexArray, googleToKaidex, } from "@google/kaidex-cli-core";
    ...
    addToolResponsesToHistory(completedTools) {
        ...
        for (const response of responsesToAdd) {
            ...
            if (Array.isArray(response)) {
                ...
                parts = partListUnionToKaidexArray([response]);
            }
    ...
    async *sendCompletedToolsToLlm(completedToolCalls, aborted) {
        ...
        for (const completedToolCall of completedToolCalls) {
            ...
            if (Array.isArray(responseParts)) {
                llmParts.push(...partListUnionToKaidexArray(responseParts));
            }
            else {
        ...
        yield* this.kaidexClient.sendMessageStream(llmParts, aborted, 
        /*prompt_id*/ "");
    }
