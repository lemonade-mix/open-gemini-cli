 ...
 */
import { CoreToolScheduler, type KaiDexClient } from "@google/kaidex-cli-core";
import type { CompletedToolCall, ToolCallRequestInfo, ServerKaiDexStreamEvent, ToolCallConfirmationDetails, Config } from "@google/kaidex-cli-core";
...
export declare class Task {
    ...
    acceptAgentMessage(event: ServerKaiDexStreamEvent): Promise<void>;
    ...
    sendCompletedToolsToLlm(completedToolCalls: CompletedToolCall[], aborted: AbortSignal): AsyncGenerator<ServerKaiDexStreamEvent>;
    acceptUserMessage(requestContext: RequestContext, aborted: AbortSignal): AsyncGenerator<ServerKaiDexStreamEvent>;
