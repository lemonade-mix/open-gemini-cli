 ...
 */
import { ApprovalMode, DEFAULT_TRUNCATE_TOOL_OUTPUT_LINES, DEFAULT_TRUNCATE_TOOL_OUTPUT_THRESHOLD, KaiDexClient, } from "@google/kaidex-cli-core";
...
export function createMockConfig(overrides = {}) {
    ...
    mockConfig.getKaiDexClient = vi
        .fn()
        .mockReturnValue(new KaiDexClient(mockConfig));
    return mockConfig;
}
