...
import { DiscoveredMCPTool, getMCPDiscoveryState, getMCPServerStatus, MCPDiscoveryState, MCPServerStatus, mcpServerRequiresOAuth, getErrorMessage, MCPOAuthTokenStorage, } from "@google/kaidex-cli-core";
...
const getMcpStatus = async (context, showDescriptions, showSchema, showTips = false) => {
    ...
    for (const serverName of serverNames) {
        ...
        if (server?.oauth?.enabled) {
            needsAuthHint = true;
            try {
                const { MCPOAuthTokenStorage } = await import("@google/kaidex-cli-core");
...
const authCommand = {
    ...
    action: async (context, args) => {
        ...
        try {
            ...
            const { MCPOAuthProvider } = await import("@google/kaidex-cli-core");
