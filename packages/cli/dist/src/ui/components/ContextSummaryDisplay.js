...
export const ContextSummaryDisplay = ({ kaidexMdFileCount, contextFileNames, mcpServers, blockedMcpServers, showToolDescriptions, ideContext, }) => {
    ...
    const kaidexMdText = (() => {
        ...
        return `${kaidexMdFileCount} ${name} file${kaidexMdFileCount > 1 ? "s" : ""}`;
    })();
    const mcpText = (() => {
