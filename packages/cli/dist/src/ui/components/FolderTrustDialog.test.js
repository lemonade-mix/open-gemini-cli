...
describe("FolderTrustDialog", () => {
    ...
    it("should render the dialog with title and description", () => {
        ...
        expect(lastFrame()).toContain("Trusting a folder allows KaiDex to execute commands it suggests.");
    });
    ...
    it("should display restart message when isRestarting is true", () => {
        ...
        expect(lastFrame()).toContain("To see changes, KaiDex CLI must be restarted");
    });
