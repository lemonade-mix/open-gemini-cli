...
export const ToolGroupMessage = ({ toolCalls, availableTerminalHeight, terminalWidth, isFocused = true, }) => {
    ...
    const borderColor = hasPending || isShellCommand ? theme.status.warning : theme.border.default;
