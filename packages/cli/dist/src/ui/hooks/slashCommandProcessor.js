...
import { GitService, Logger, logSlashCommand, makeSlashCommandEvent, SlashCommandStatus, ToolConfirmationOutcome, Storage, IdeClient, } from "@google/kaidex-cli-core";
 ...
 */
export const useSlashCommandProcessor = (config, settings, addItem, clearItems, loadHistory, refreshStatic, toggleVimEnabled, setIsProcessing, setGeminiMdFileCount, actions) => {
    ...
    const commandContext = useMemo(() => ({
        ...
        ui: {
            ...
            toggleVimEnabled,
            setKaidexMdFileCount: setGeminiMdFileCount,
            reloadCommands,
        },
        session: {
            stats: session.stats,
                ...
                if (commandToExecute.action) {
                    ...
                    if (result) {
                        switch (result.type) {
                            ...
                            case "load_history": {
                                config?.getKaiDexClient()?.setHistory(result.clientHistory);
