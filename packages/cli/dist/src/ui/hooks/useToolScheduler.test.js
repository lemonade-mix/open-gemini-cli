...
import { DEFAULT_TRUNCATE_TOOL_OUTPUT_LINES, DEFAULT_TRUNCATE_TOOL_OUTPUT_THRESHOLD, ToolConfirmationOutcome, ApprovalMode, MockTool, } from "@google/kaidex-cli-core";
...
const mockConfig = {
    ...
    getKaiDexClient: () => null, // No client needed for these tests
};
