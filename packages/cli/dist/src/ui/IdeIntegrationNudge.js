...
export function IdeIntegrationNudge({ ide, onComplete, }) {
    ...
    return (_jsxs(Box, { flexDirection: "column", borderStyle: "round", borderColor: "yellow", padding: 1, width: "100%", marginLeft: 1, children: [_jsxs(Box, { marginBottom: 1, flexDirection: "column", children: [_jsxs(Text, { children: [_jsx(Text, { color: "yellow", children: "> " }), `Do you want to connect ${ideName ?? "your editor"} to KaiDex CLI?`] }), _jsx(Text, { dimColor: true, children: installText })] }), _jsx(RadioButtonSelect, { items: OPTIONS, onSelect: onComplete })] }));
}
