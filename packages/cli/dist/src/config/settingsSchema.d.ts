 ...
 */
import type { MCPServerConfig, BugCommandSettings, TelemetrySettings, AuthType, ChatCompressionSettings } from "@google/kaidex-cli-core";
    ...
    readonly ui: {
        ...
        readonly properties: {
            ...
            readonly hideContextSummary: {
                ...
                readonly requiresRestart: false;
                readonly default: false;
                readonly description: "Hide the context summary (KAIDEX.md, MCP servers) above the input.";
                readonly showInDialog: true;
            };
            readonly footer: {
                readonly type: "object";
    ...
    readonly model: {
        ...
        readonly properties: {
            readonly name: {
                ...
                readonly requiresRestart: false;
                readonly default: string | undefined;
                readonly description: "The KaiDex model to use for conversations.";
                readonly showInDialog: false;
            };
            ...
            readonly fileFiltering: {
                ...
                readonly properties: {
                    ...
                    readonly respectGeminiIgnore: {
                        readonly type: "boolean";
                        readonly label: "Respect .kaidexignore";
                        readonly category: "Context";
                        readonly requiresRestart: true;
                        readonly default: true;
                        readonly description: "Respect .kaidexignore files when searching";
                        readonly showInDialog: true;
                    };
