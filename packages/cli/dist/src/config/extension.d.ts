 ...
 */
import type { MCPServerConfig, GeminiCLIExtension } from "@google/kaidex-cli-core";
...
export declare const INSTALL_METADATA_FILENAME = ".kaidex-extension-install.json";
...
export declare function updateExtensionByName(extensionName: string, cwd?: string): Promise<ExtensionUpdateInfo>;
export declare function updateExtension(extension: Extension, cwd?: string): Promise<ExtensionUpdateInfo>;
...
export declare function updateAllUpdatableExtensions(cwd?: string): Promise<ExtensionUpdateInfo[]>;
