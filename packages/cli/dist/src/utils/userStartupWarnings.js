...
const rootDirectoryCheck = {
    ...
    check: async (workspaceRoot) => {
        try {
            ...
            const errorMessage = "Warning: You are running KaiDex CLI in the root directory. Your entire folder structure will be used for context. It is strongly recommended to run in a project-specific directory.";
...
export async function getUserStartupWarnings(workspaceRoot = process.cwd()) {
