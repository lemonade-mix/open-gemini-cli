...
describe("getInstallationInfo", () => {
    ...
    it("should detect global pnpm installation", () => {
        const pnpmPath = `/Users/test/.pnpm/global/5/node_modules/.pnpm/some-hash/node_modules/@google/kaidex-cli/dist/index.js`;
        ...
        expect(info.isGlobal).toBe(true);
        expect(info.updateCommand).toBe("pnpm add -g @google/kaidex-cli@latest");
    ...
    it("should detect global yarn installation", () => {
        const yarnPath = `/Users/test/.yarn/global/node_modules/@google/kaidex-cli/dist/index.js`;
        ...
        expect(info.isGlobal).toBe(true);
        expect(info.updateCommand).toBe("yarn global add @google/kaidex-cli@latest");
        expect(info.updateMessage).toContain("Attempting to automatically update");
        const infoDisabled = getInstallationInfo(projectRoot, true);
    ...
    it("should detect global bun installation", () => {
        ...
        expect(info.isGlobal).toBe(true);
        expect(info.updateCommand).toBe("bun add -g @google/kaidex-cli@latest");
        expect(info.updateMessage).toContain("Attempting to automatically update");
        const infoDisabled = getInstallationInfo(projectRoot, true);
    ...
    it("should default to global npm installation for unrecognized paths", () => {
        ...
        expect(info.packageManager).toBe(PackageManager.NPM);
        expect(info.isGlobal).toBe(true);
        expect(info.updateCommand).toBe("npm install -g @google/kaidex-cli@latest");
        expect(info.updateMessage).toContain("Attempting to automatically update");
        const infoDisabled = getInstallationInfo(projectRoot, true);
