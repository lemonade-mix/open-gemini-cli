...
import { useKaiDexStream } from "./useKaiDexStream.js";
...
const MockedKaiDexClientClass = vi.hoisted(() =>
...
vi.mock("@google/kaidex-cli-core", async (importOriginal) => {
  ...
  return {
    ...actualCoreModule,
    GitService: vi.fn(),
    KaiDexClient: MockedKaiDexClientClass,
...
// --- Tests for useKaiDexStream Hook ---
describe("useKaiDexStream", () => {
  ...
  beforeEach(() => {
    ...
    mockAddItem = vi.fn();
    // Define the mock for getKaiDexClient
    const mockGetKaiDexClient = vi.fn().mockImplementation(() => {
      // MockedKaiDexClientClass is defined in the module scope by the previous change.
      // It will use the mockStartChat and mockSendMessageStream that are managed within beforeEach.
      const clientInstance = new MockedKaiDexClientClass(mockConfig);
    ...
    // Reset mocks for KaiDexClient instance methods (startChat and sendMessageStream)
    // The KaiDexClient constructor itself is mocked at the module level.
    mockStartChat.mockClear().mockResolvedValue({
      sendMessageStream: mockSendMessageStream,
    } as unknown as any); // KaiDexChat -> any
  ...
  const mockLoadedSettings: LoadedSettings = {
    ...
    workspace: { path: "/workspace/.kaidex/settings.json", settings: {} },
    errors: [],
    forScope: vi.fn(),
    setValue: vi.fn(),
  ...
  const renderTestHook = (
    ...
    const client = geminiClient || mockConfig.getKaiDexClient();
  ...
  it("should submit tool responses when all tool calls are completed and ready", async () => {
    ...
    renderHook(() =>
      useKaiDexStream(
        new MockedKaiDexClientClass(mockConfig),
        [],
        mockAddItem,
        mockConfig,
        mockLoadedSettings,
  ...
  it("should handle all tool calls being cancelled", async () => {
    ...
    const client = new MockedKaiDexClientClass(mockConfig);
  ...
  describe("Slash Command Handling", () => {
    ...
    it("should stop processing and not call KaiDex when a command is handled without a tool call", async () => {
    ...
    it("should call KaiDex with prompt content when slash command returns a `submit_prompt` action", async () => {
  ...
  describe("Error Handling", () => {
    it("should call parseAndFormatApiError with the correct authType on stream initialization failure", async () => {
      ...
      const { result } = renderHook(() =>
        useKaiDexStream(
          new MockedKaiDexClientClass(testConfig),
          [],
          mockAddItem,
          testConfig,
          mockLoadedSettings,
  ...
  describe("handleFinishedEvent", () => {
    it("should add info message for MAX_TOKENS finish reason", async () => {
      ...
      mockSendMessageStream.mockReturnValue(
        (async function* () {
          yield {
            type: ServerKaiDexEventType.Content,
            value: "This is a truncated response...",
          };
          yield {
            type: ServerKaiDexEventType.Finished,
  ...
  it("should process @include commands, adding user turn after processing to prevent race conditions", async () => {
    ...
    const { result } = renderHook(() =>
      useKaiDexStream(
        mockConfig.getKaiDexClient() as KaiDexClient,
        [],
        mockAddItem,
        mockConfig,
        mockLoadedSettings,
  ...
  describe("Thought Reset", () => {
    it("should reset thought to null when starting a new prompt", async () => {
      ...
      mockSendMessageStream.mockReturnValue(
        (async function* () {
          yield {
            type: ServerKaiDexEventType.Thought,
            value: {
    ...
    it("should reset thought to null when user cancels", async () => {
      ...
      mockSendMessageStream.mockReturnValue(
        (async function* () {
          ...
          yield { type: ServerKaiDexEventType.UserCancelled };
        })(),
      );
    ...
    it("should reset thought to null when there is an error", async () => {
      ...
      mockSendMessageStream.mockReturnValue(
        (async function* () {
          ...
          yield {
            type: ServerKaiDexEventType.Error,
