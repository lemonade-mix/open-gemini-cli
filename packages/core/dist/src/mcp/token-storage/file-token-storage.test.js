...
describe("FileTokenStorage", () => {
    ...
    describe("getCredentials", () => {
        it("should throw error when file does not exist", async () => {
            ...
            await expect(storage.getCredentials("test-server")).rejects.toThrow("Token file does not exist");
        });
    ...
    describe("setCredentials", () => {
        it("should save credentials with encryption", async () => {
            ...
            expect(mockFs.mkdir).toHaveBeenCalledWith(path.join("/home/test", ".kaidex"), { recursive: true, mode: 0o700 });
    ...
    describe("deleteCredentials", () => {
        it("should throw when credentials do not exist", async () => {
            mockFs.readFile.mockRejectedValue({ code: "ENOENT" });
            await expect(storage.deleteCredentials("test-server")).rejects.toThrow("Token file does not exist");
        });
        it("should delete file when last credential is removed", async () => {
            ...
            expect(mockFs.unlink).toHaveBeenCalledWith(path.join("/home/test", ".kaidex", "mcp-oauth-tokens-v2.json"));
        });
    ...
    describe("listServers", () => {
        it("should throw error when file does not exist", async () => {
            mockFs.readFile.mockRejectedValue({ code: "ENOENT" });
            await expect(storage.listServers()).rejects.toThrow("Token file does not exist");
        });
