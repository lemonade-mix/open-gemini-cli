...
${userPrompt}`,
    ...
    const result = (await geminiClient.generateJson(googleContentArrayToKaidex(contents), SearchReplaceEditSchema, abortSignal, DEFAULT_KAIDEX_FLASH_MODEL, {}, // config
    "llm-edit-fixer"));
