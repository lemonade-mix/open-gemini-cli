 ...
 */
export type Summarizer = (result: ToolResult, geminiClient: KaiDexClient, abortSignal: AbortSignal) => Promise<string>;
/**
...
export declare function summarizeToolOutput(textToSummarize: string, geminiClient: KaiDexClient, abortSignal: AbortSignal, maxOutputTokens?: number): Promise<string>;
