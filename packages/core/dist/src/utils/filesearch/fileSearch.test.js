...
describe("FileSearch", () => {
    ...
    it("should use .kaidexignore rules", async () => {
        ...
        expect(results).toEqual(["src/", ".kaidexignore", "src/not-ignored.js"]);
    });
    it("should combine .gitignore and .kaidexignore rules", async () => {
        tmpDir = await createTmpDir({
            ".gitignore": "dist/",
            ".kaidexignore": "build/",
