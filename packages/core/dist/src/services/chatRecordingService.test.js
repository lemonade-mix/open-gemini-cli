...
describe("ChatRecordingService", () => {
        ...
        mockConfig = {
            ...
            storage: {
                getProjectTempDir: vi
                    .fn()
                    .mockReturnValue("/test/project/root/.kaidex/tmp"),
            },
    ...
    describe("initialize", () => {
        it("should create a new session if none is provided", () => {
            ...
            expect(mkdirSyncSpy).toHaveBeenCalledWith("/test/project/root/.kaidex/tmp/chats", { recursive: true });
        ...
        it("should resume from an existing session if provided", () => {
            ...
            const writeFileSyncSpy = vi
                ...
                .mockImplementation(() => undefined);
            chatRecordingService.initialize({
                filePath: "/test/project/root/.kaidex/tmp/chats/session.json",
                conversation: {
                    sessionId: "old-session-id",
                },
            });
    ...
    describe("deleteSession", () => {
        it("should delete the session file", () => {
            ...
            expect(unlinkSyncSpy).toHaveBeenCalledWith("/test/project/root/.kaidex/tmp/chats/test-session-id.json");
        });
    });
});
