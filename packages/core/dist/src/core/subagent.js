...
`);
    ...
    async createChatObject(context) {
        ...
        try {
            ...
            return new KaiDexChat(this.runtimeContext, generationConfig, start_history);
        }
        catch (error) {
            await reportError(error, "Error initializing KaiDex chat session.", start_history, "startChat");
