...
import { KaiDexChat, EmptyStreamError, StreamEventType, } from "./kaidexChat.js";
...
describe("KaiDexChat", () => {
    ...
    beforeEach(() => {
        ...
        chat = new KaiDexChat(mockConfig, config, []);
    });
    afterEach(() => {
        vi.restoreAllMocks();
        vi.resetAllMocks();
    ...
    describe("sendMessageStream with retries", () => {
        ...
        it("should fail after all retries on persistent invalid content and report metrics", async () => {
            vi.mocked(mockContentGenerator.generateContentStream).mockImplementation(() => (async function* () {
                yield {
                    candidates: [
                        {
                            content: {
...
//# sourceMappingURL=kaidexChat.test.js.map