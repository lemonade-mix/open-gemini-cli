...
export class UiTelemetryService extends EventEmitter {
    ...
    processApiResponse(event) {
        ...
        debugLog(`🔢 [${new Date().toISOString()}] TOKEN_TELEMETRY_PROCESS_API_RESPONSE: input_token_count=${event.input_token_count}, output_token_count=${event.output_token_count}, total_token_count=${event.total_token_count}`);
        ...
        debugLog(`🔢 [${new Date().toISOString()}] TOKEN_TELEMETRY_STORED: lastPromptTokenCount=${this.#lastPromptTokenCount}`);
    }
