...
---
`;
            const result = await geminiClient.generateContent([{ role: "user", parts: [{ text: fallbackPrompt }] }], {}, signal, DEFAULT_KAIDEX_FLASH_MODEL);
    ...
    async execute(signal) {
        ...
        try {
            ...
            const urlContextMeta = response.candidates?.[0]
                ?.urlContextMetadata;
