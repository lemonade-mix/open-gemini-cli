...
export declare const GEMINI_CONFIG_DIR = ".kaidex";
export declare const DEFAULT_CONTEXT_FILENAME = "KAIDEX.md";
export declare const MEMORY_SECTION_HEADER = "## KaiDex Added Memories";
