...
import type { CountTokensParameters, CountTokensResponse, EmbedContentParameters, EmbedContentResponse, GenerateContentParameters, GenerateContentResponse, ChatCompletionRequest, ChatCompletionResponse } from "../core/contentGenerator.js";
...
export declare class CodeAssistServer implements ContentGenerator {
    ...
    generateContentStream(req: GenerateContentParameters, userPromptId: string): AsyncGenerator<GenerateContentResponse>;
