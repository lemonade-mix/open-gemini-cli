...
describe("oauth2", () => {
    ...
    it("should perform a web login", async () => {
        ...
        const googleAccountPath = path.join(tempHomeDir, ".kaidex", "google_accounts.json");
    ...
    describe("in Cloud Shell", () => {
        ...
        it("should attempt to load cached credentials first", async () => {
            ...
            const credsPath = path.join(tempHomeDir, ".kaidex", "oauth_creds.json");
    ...
    describe("credential loading order", () => {
        it("should prioritize default cached credentials over GOOGLE_APPLICATION_CREDENTIALS", async () => {
            ...
            const defaultCredsPath = path.join(tempHomeDir, ".kaidex", "oauth_creds.json");
