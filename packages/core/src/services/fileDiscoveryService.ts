...
const GEMINI_IGNORE_FILE_NAME = ".kaidexignore";
...
export class FileDiscoveryService {
  ...
  private kaidexIgnoreFilter: GitIgnoreFilter | null = null;
  ...
  constructor(projectRoot: string) {
    ...
    this.kaidexIgnoreFilter = gParser;
  }
  ...
  shouldGeminiIgnoreFile(filePath: string): boolean {
    if (this.kaidexIgnoreFilter) {
      return this.kaidexIgnoreFilter.isIgnored(filePath);
    }
    return false;
  }
  ...
  /**
   * Returns loaded patterns from .kaidexignore
   */
  getGeminiIgnorePatterns(): string[] {
    return this.kaidexIgnoreFilter?.getPatterns() ?? [];
  }
}
