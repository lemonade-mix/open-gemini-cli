...
let mockKaiDexClientInstance: Mocked<KaiDexClient>;
...
describe("WriteFileTool", () => {
  ...
  beforeEach(() => {
    ...
    mockKaiDexClientInstance = new (vi.mocked(KaiDexClient))(
      mockConfig,
    ) as Mocked<KaiDexClient>;
    ...
    mockConfigInternal.getKaiDexClient.mockReturnValue(
      mockKaiDexClientInstance,
    );
