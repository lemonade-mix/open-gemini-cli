...
import { DEFAULT_KAIDEX_MODEL, DEFAULT_KAIDEX_FLASH_MODEL } from "./models.js";
...
describe("Flash Model Fallback Configuration", () => {
  ...
  describe("setModel", () => {
    it("should only mark as switched if contentGeneratorConfig exists", () => {
      ...
      newConfig.setModel(DEFAULT_KAIDEX_FLASH_MODEL);
  ...
  describe("getModel", () => {
    it("should return contentGeneratorConfig model if available", () => {
      ...
      config.setModel(DEFAULT_KAIDEX_FLASH_MODEL);
      expect(config.getModel()).toBe(DEFAULT_KAIDEX_FLASH_MODEL);
    });
