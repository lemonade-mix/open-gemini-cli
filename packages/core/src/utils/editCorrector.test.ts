...
vi.mock("../core/client.js", () => ({
  KaiDexClient: vi.fn().mockImplementation(function (
    this: any,
    _config: Config,
  ) {
  ...
  describe("ensureCorrectEdit", () => {
    ...
    beforeEach(() => {
      ...
      mockConfigInstance = {
        ...
        setKaiDexMdFileCount: vi.fn((count: number) => {
      ...
      mockKaiDexClientInstance = new KaiDexClient(
        mockConfigInstance,
    ...
    describe("Scenario Group 6: Concurrent Edits", () => {
      it("Test 6.1: should return early if file was modified by another process", async () => {
        ...
        (mockKaiDexClientInstance.getHistory as Mock).mockResolvedValue(
          history,
        );
