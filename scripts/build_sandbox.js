...
console.log("packing @google/kaidex-cli ...");
const cliPackageDir = join("packages", "cli");
rmSync(join(cliPackageDir, "dist", "google-gemini-cli-*.tgz"), { force: true });
execSync(
  `npm pack -w @google/kaidex-cli --pack-destination ./packages/cli/dist`,
  {
    stdio: "ignore",
  },
);

console.log("packing @google/kaidex-cli-core ...");
const corePackageDir = join("packages", "core");
rmSync(join(corePackageDir, "dist", "google-gemini-cli-core-*.tgz"), {
  force: true,
});
execSync(
  `npm pack -w @google/kaidex-cli-core --pack-destination ./packages/core/dist`,
  { stdio: "ignore" },
);
