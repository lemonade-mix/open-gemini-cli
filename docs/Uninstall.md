...
If you installed the CLI globally (e.g., `npm install -g @google/kaidex-cli`), use the `npm uninstall` command with the `-g` flag to remove it.

```bash
npm uninstall -g @google/kaidex-cli
```
